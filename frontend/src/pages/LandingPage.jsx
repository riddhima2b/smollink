        ...
        <>
         ...
         <div className="relative min-h-screen bg-radial bg-[#0B0A12] font-serif brightness-100 opacity-95">
                ...
                <div className="flex-col flex items-center justify-center gap-2 px-4 py-6 p-6 mx-auto rounded-md text-xl"> 
                    ...
                    <input type="text" value={longUrl} onChange={change} placeholder="https://example.com/your/very/long/url/here" className="border border-blue-200 p-2 rounded-md  w-full max-w-125 text-white" />
                    <div className="flex items-center gap-2  w-full max-w-125 border border-cyan-300 bg-radial bg-[#087f99] p-2 rounded-md">
                    <input type="text" value={shortUrl} readOnly placeholder = "shortened-url/here" className=" text-white flex-1"/>
                    <CopyButton text={shortUrl} />
                    </div>
                    <button id ="smollink-button" className="border border-lime-600 bg-radial bg-lime-400 p-2 mt-4 rounded-md text-black  w-full max-w-125 pointer-events-auto hover:bg-lime-700 hover:border-lime-200" onClick ={smollify}>Shrink it!</button>
                    <br></br>
