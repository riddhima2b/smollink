        ...
        <div className="min-h-screen bg-[#1d1c22] text-[#f5f1eb] font-serif">
            ...
            <main className="mx-auto max-w-7xl px-6 py-6">
                ...
                <form onSubmit={smollify} className="flex flex-col items-center justify-center gap-4 py-6">
                    ...
                    <button id ="smollink-button" type="button" className="border border-lime-600 bg-radial bg-lime-400 p-2 mt-4 rounded-md text-black w-40 pointer-events-auto hover:bg-lime-700 hover:border-lime-200">Shrink it!</button>
                    </div>
